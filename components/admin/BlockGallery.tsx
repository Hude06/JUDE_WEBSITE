...
const blockTemplates: BlockTemplate[] = [
  ...
  },
  {
    ...
    description: 'Product shot with floating callout chips',
    icon: '◐',
    create: (id) => ({
      id,
      type: 'annotated-hero',
      ...
      subheadline: 'A tagline that sets the promise.',
      ...
      imageAlt: 'Product shot',
      imagePosition: 'left',
      imageAspect: 'landscape',
      annotations: [
        { id: `${id}-a1`, text: 'try me!', x: 25, y: 70, variant: 'note', rotate: -2, delay: 0.2 },
        { id: `${id}-a2`, text: 'features', x: 55, y: 35, variant: 'popover', delay: 0.35 },
        { id: `${id}-a3`, text: 'click', x: 40, y: 12, variant: 'callout', emoji: '👆', rotate: 2, delay: 0.5 },
      ],
    }),
  },
  {
